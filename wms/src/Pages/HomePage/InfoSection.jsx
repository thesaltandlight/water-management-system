function InfoSection(){
    return(
        <div className="bg-[#DDE9F5] rounded-xl p-8 flex justify-between items center mx-40123
         lg:mx-20 shadow-lg fade-in-slide-up">
            ...
            <div className="flex-1 text-center px-4">
                ...
                <p className="text-[#393939]">Enjoy the crisp taste of our fresh filtered water, sourced from pristine locations for the purest quality.</p>
            </div>
            ...
            <div className="flex-1 text-center px-4">
                ...
                <p className="text-[#393939]">Experience the cool, refreshing sensation of our premium water that quenches your thirst instantly.</p>
            </div>
