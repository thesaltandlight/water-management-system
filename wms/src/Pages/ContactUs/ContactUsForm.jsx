...
function ContactUsForm() {
  ...
  return (
    <div className="bg-[#FFFFFF] p-8 mx-4 lg:mx-20 fade-in-slide-up flex flex-col my-10 -mt-24">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start">
        <div className="flex-1 mr-8 mb-8 lg:mb-0">
          <form className="space-y-4">
            ...
            {error && <p className='text-[#E93737] flex items-center'><FaExclamation className='text-[#E93737] -mr-0'></FaExclamation>Uh oh! You missed a spot. Please fill in all fields and try again</p>}
