    ...
    return(
        <div className="flex flex-col lg:flex-row gap-10">
            <div className="lg:w-8/12">
                ...
                <div className="grid grid-cols-12 gap-20 mb-4 p-4 font-semibold text-[20px]">
                ...
                {cart.map(product => (
                    <div key={product.id} className="grid grid-cols-12 gap-20 p-4 border-b border-gray-200">
                        {/* product */}
