        ...
        <div className="fixed inset-0 overflow-hidden">
            ...
            <div className="flex h-full">
                ...
                <div className="w-1/2 p-6 overflow-auto">
                    ...
                    <p className="text-4xl font-medium text-[#7BA5C9] mb-4">₵{product.price.toFixed(2)}</p>
                    <button className="bg-[#24619D] font-semibold text-[#FFFFFF] px-6 py-3 rounded-lg shadow-lg hover:bg-[#113e6c] transition duration-300" onClick={handleAddToCart}>Add To Cart</button>
